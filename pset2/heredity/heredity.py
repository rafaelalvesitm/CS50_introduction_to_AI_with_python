...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # If person has parents
            ...
            if genes == 2:
                probability = probability * passing[mother] * passing[father]
            elif genes == 1:
                probability = probability * passing[mother] * (1 - passing[father]) + (1 - passing[mother]) * passing[father]
            else:
                 probability = probability * (1 - passing[mother]) * (1 - passing[father])
